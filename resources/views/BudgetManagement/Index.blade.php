    ...
    @foreach($budgets as $key => $value)
        <tr>
            ...
            <td class="col-6">
                ...
                {{ Form::close() }} </a>
                <a class="btn btn-small btn-success" href="{{ URL::to('BudgetManagement/' . $value->id) }}">@lang('messages.showExp')</a>

                <a class="btn btn-small btn-info" href="{{ URL::to('BudgetManagement/' . $value->id . '/edit') }}">@lang('messages.editExp')</a>
